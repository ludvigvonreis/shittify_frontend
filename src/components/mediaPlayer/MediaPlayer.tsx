		...
		setQueue([
			{
				...
				duration: 192,
				index: 3,
				path: "http://192.168.198.128:3000/v1/static/tracks/oRcLE6ggK1SxhI2GlvxB9.mp3",
				image: "http://192.168.198.128:3000/v1/static/images/yIpx__cbkgcDqn-5MExIG.png",
			},
			{
				artist_id: "",
				artist: "The Strokes",
				...
				duration: 154,
				index: 8,
				path: "http://192.168.198.128:3000/v1/static/tracks/JhEMJxyvocHwj9PxmuKrH.mp3",
				image: "http://192.168.198.128:3000/v1/static/images/lmqvyYaeM-GMCY4zlRA0f.png",
			},
			{
				...
				album: "The Wall",
				image: "http://192.168.198.128:3000/v1/static/images/9JiEfD2STlyGgw0zpbEhC.png",
				track_id: "OrzZgVgEAGyAcv7VZNtlP",
				name: "One Of My Turns",
				duration: 216,
				index: 10,
				path: "http://192.168.198.128:3000/v1/static/tracks/L0AziOphiBEVUOVhZU1H1.mp3",
			},
			{
				artist_id: "KAVcotc8s30hqndLSpNfG",
				artist: "Pink Floyd",
				...
				duration: 238,
				index: 5,
				path: "http://192.168.198.128:3000/v1/static/tracks/S9S6sNSHgwn98ZRoGoBbU.mp3",
			},
			{
				...
				duration: 208,
				index: 2,
				path: "http://192.168.198.128:3000/v1/static/tracks/QKxnyaP1qvrIMGu4AxKfD.mp3",
			},
		]);
	}, []);
